  ...
  return (
    <Card hoverable className="overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white text-center">
        ...
        <p className="text-blue-100 mb-1">Certificate of Completion</p>
        <p className="text-sm text-blue-200">Awarded to</p>
      ...
      <div className="p-6">
        ...
        <div className="mb-4 p-3 bg-gray-50 rounded-lg">
          ...
          <p className="text-sm font-mono text-gray-900">{certificate.certificateId}</p>
        </div>
